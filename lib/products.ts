...
export const PRODUCTS: ReadonlyArray<Product> = [
  ...
  },
  {
    ...
    catKey: "screens",
    name: "Проекционный экран AVRON VR100",
    shortName: "VR100",
    desc: "Напольный проекционный экран с натяжным полотном на раме. Диагональ 100 дюймов, формат 16:9, матовое белое полотно 224×124 см и ручной привод.",
    details: [
      "AVRON VR100 — напольный экран с натяжным полотном на раме: конструкция держит полотно идеально ровным, без волн и провисаний, поэтому изображение остаётся чётким по всей площади.",
      "Диагональ 100 дюймов и соотношение сторон 16:9 (224×124 см) подходят для фильмов, презентаций, обучения и рекламных показов. Матовое белое полотно даёт равномерную яркость и широкий угол обзора без бликов.",
      "Ручной привод и напольная установка позволяют развернуть экран за пару минут в любом помещении и так же быстро убрать его — не требуется крепление к стене или потолку.",
    ],
    advantages: [
      "Большая диагональ 100 дюймов в формате 16:9",
      "Натяжное полотно на раме — ровная картинка без складок",
      "Матовое белое покрытие: равномерная яркость и широкий угол обзора",
      "Напольная установка — не нужно сверлить стену или потолок",
      "Простой ручной привод и быстрая сборка",
    ],
    price: 29990,
    oldPrice: null,
    discount: null,
